...
function supabasePublishableKey(): string {
  ...
  if (keyset) {
    try {
      ...
      // Dicionário malformado — cai para os nomes legados abaixo.
    }
  }
...
/**
 * Cliente que encaminha o bearer token verificado — a RLS roda como o usuário
 * autenticado. Nunca há fallback anônimo em ferramentas autenticadas.
 */
